...
/**
 * Created by benefic on 20.01.17.
 */

public class WawAuthenticator extends AbstractAccountAuthenticator {
    private Context mContext;

    public WawAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
